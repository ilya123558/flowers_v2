      ...
      {isAuth
        ? (
          <div className="flex-center">
            <Button onClick={() => dispatch(setOpenBasket())} className="relative active:scale-95 flex items-end h-[50px]">
              <div className="w-[50px] aspect-square rounded-full bg-button-light-bg flex-center">
                ...
                <motion.div
                  ...
                  animate={{
                    scale: [1, 1.2, 1],
                    backgroundColor: ['#1a1f35', '#EDBF81', '#1a1f35']
                  }}
                  transition={{
                    duration: 0.5,
                    ease: "easeInOut"
                  }}
                  className="absolute border-button-light-bg border-[1px] rounded-full max-h-[20px] h-full aspect-square flex-center will-change-transform bg-dark-blue top-[-2px] right-[-2px]"
                >
                  <motion.p
                    key={`count-${basketCount}`}
            ...
            <LgShow>
              <div className="ml-[16px]">
                <Button onClick={() => setIsOpenMenu(!isOpenMenu)} className="active:scale-95 aspect-square h-[50px] flex-center">
