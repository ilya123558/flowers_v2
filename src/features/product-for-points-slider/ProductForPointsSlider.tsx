            ...
            <BoxWrapper className='rounded-[16px] overflow-hidden h-full'>
              <div className="aspect-[290/168] w-full relative">
                ...
                <div className="absolute bg-[#2B2B2BB2] p-[7px_8px] top-[9px] left-[8px] rounded-[9px] flex-center gap-[4px]">
                  ...
                  <p className="text-[#DADADA] text-[14px]">23 балла</p>
                </div>
                <div className="absolute top-[9px] right-[8px] rounded-[9px] flex bg-[#2B2B2BB2]">
                  <Button onClick={() => {}} className="active:scale-95">
                    <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M26.2565 15.962C26.7305 16.582 26.7305 17.419 26.2565 18.038C24.7635 19.987 21.1815 24 16.9995 24C12.8175 24 9.23552 19.987 7.74252 18.038C7.51191 17.7411 7.38672 17.3759 7.38672 17C7.38672 16.6241 7.51191 16.2589 7.74252 15.962C9.23552 14.013 12.8175 10 16.9995 10C21.1815 10 24.7635 14.013 26.2565 15.962Z" fill="#D9D9D9" fillOpacity="0.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M17 20C18.6569 20 20 18.6569 20 17C20 15.3431 18.6569 14 17 14C15.3431 14 14 15.3431 14 17C14 18.6569 15.3431 20 17 20Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </Button>
                  <Button onClick={() => {}} className="active:scale-95">
                    <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13 10C10.7912 10 9 11.7396 9 13.8859C9 15.6185 9.7 19.7305 16.5904 23.8873C16.7138 23.961 16.8555 24 17 24C17.1445 24 17.2862 23.961 17.4096 23.8873C24.3 19.7305 25 15.6185 25 13.8859C25 11.7396 23.2088 10 21 10C18.7912 10 17 12.3551 17 12.3551C17 12.3551 15.2088 10 13 10Z" fill="#D9D9D9" fillOpacity="0.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </Button>
                </div>
              </div>
              <div className="p-[16px]">
                <div className=''>
                  ...
                  <p className='text-[20px] mt-[10px]'>{item.price}</p>
                  <ul className="flex gap-[8px] h-[43px] mt-[10px] overflow-x-scroll">
                    {item.tags.map((tag, i, tagArr) => {
                      if(tagArr.length > 2 && i >= 2) {
                        if(i === (tagArr.length - 1)) {
                          return (
                            <li key={i} className='bg-[#252525] flex-center p-[0px_10px] rounded-[8px] text-nowrap'>
                              ...
                            </li>
                          )
                        }
                ...
                <div className="mt-[16px] flex items-center gap-[9px] h-[42px]">
                  <Button onClick={() => {}} className='h-full w-full border-[1px] border-yellow rounded-[11px] active:scale-95'>
                    <div className="flex-center gap-[8px]">
                      ...
                      <p className='text-yellow text-[16px] font-bold text-nowrap'>В корзину</p>
                    </div>
                  </Button>
                  <Button onClick={() => {}} className='h-full w-full rounded-[11px] active:scale-95'>
                    <div className="flex-center gap-[8px]">
