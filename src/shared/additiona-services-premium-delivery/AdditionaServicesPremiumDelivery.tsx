...
export const AdditionaServicesPremiumDelivery = () => {
  ...
  return (
    <BoxWrapper className="w-full p-[16px_24px] rounded-[14px]">
      <div className="">
        <InfoWithToggle
          toggle={isPremiumDelivery} 
          setToggle={setIsPremiumDelivery} 
      ...
      {/* <AnimationHeightWrapper isOpen={isCheckedPremiumDelivery}>
        <div className="mt-[11px] flex sm:flex-row flex-col items-center gap-[11px]">
          <div className="sm:w-fit w-full flex items-center gap-[4px] p-[9.5px_10px] rounded-[8px] bg-[#252525]">
      ...
      <div className="h-[40px] flex items-center justify-between mt-[11px]">
