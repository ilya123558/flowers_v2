        ...
        <div className="">
          ...
          <div className="mt-[24px] sm:p-[32px] p-[10px] bg-[#212121] rounded-[8px]">
            ...
            {pathname.includes('policy') && (
              <div className="mt-[24px] text-[#D9D9D9] leading-[151%] flex flex-col gap-[24px]">
                <p>Настоящая Политика конфиденциальности персональных данных (далее – Политика), размещенная на сайтах по уникальному адресу (URL): https://первыйцветочный.онлайн/ (далее — «Сайт») является официальным документом Оператора Сайта ЗЮЗИНОЙ ЕЛЕНЫ ТРОФИМОВНЫ (ИНН: 775116560156) и действует в отношении всей информации, которую Оператор может получить о Пользователе во время использования им Сайта, устанавливает обязательства Оператора по неразглашению и обеспечению режима защиты конфиденциальности персональных данных, которые Пользователь предоставляет в процессе использования Сайта.</p>
