          ...
          <div className="mt-[24px] sm:p-[32px] p-[10px] bg-[#212121] rounded-[8px]">
            ...
            {pathname.includes('offer') && (
              <div className="mt-[24px] text-[#D9D9D9] leading-[151%] flex flex-col gap-[24px]">
                <p>Настоящий документ является официальным предложением (офертой) «Первый цветочный», в лице ИП ЗЮЗИНОЙ ЕЛЕНЫ ТРОФИМОВНЫ (ИНН: 775116560156), в дальнейшем именуемый «Компания», в адрес зарегистрированных пользователей на платформе (неограниченному кругу физических, юридических лиц, включая Индивидуальный предпринимателей и самозанятых граждан, согласившихся с условиями настоящей оферты, далее- «Пользователь»), заключить договор на указанных в настоящей оферте условиях.</p>
            ...
            {pathname.includes('policy') && (
              <div className="mt-[24px] text-[#D9D9D9] leading-[151%] flex flex-col gap-[24px]">
                <p>Настоящая Политика конфиденциальности персональных данных (далее – Политика), размещенная на сайтах по уникальному адресу (URL): https://flowers-v2-two.vercel.app/ (далее — «Сайт») является официальным документом Оператора Сайта ЗЮЗИНОЙ ЕЛЕНЫ ТРОФИМОВНЫ (ИНН: 775116560156) и действует в отношении всей информации, которую Оператор может получить о Пользователе во время использования им Сайта, устанавливает обязательства Оператора по неразглашению и обеспечению режима защиты конфиденциальности персональных данных, которые Пользователь предоставляет в процессе использования Сайта.</p>
              ...
              <div className="mt-[24px] text-[#D9D9D9] leading-[151%] flex flex-col gap-[24px]">
                ...
                <div className="">
                  ...
                  <div className="mt-[8px]">
                    <p>Наименование: ЗЮЗИНА ЕЛЕНА ТРОФИМОВНА (ИП)</p>
                    <p>Адрес: проспект Мира, д. 24б, кв./оф. 133, Сахалинская область, г. Южно-Сахалинск</p>
                    <p>ИНН: 775116560156</p>
                    <p>Банк: АО "АЛЬФА-БАНК"</p>
                    <p>Номер счёта: 40802810581860000389</p>
                    <p>БИК: 044525593</p>
